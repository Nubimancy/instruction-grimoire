...
| Context | Character | ADO Team Member | License | Learning Pattern | Last Session | Status |
|---------|-----------|-----------------|---------|------------------|-------------|---------|
| **🎯 Project Management** | **Atlas** | atlas@nubimancy.com | Basic | Weekly/Bi-weekly | 2025-08-20 | ✅ Active |
| **📝 Content Creation** | **Quill** | quill@nubimancy.com | Stakeholder | Weekly + Monthly Reviews | 2025-08-18 | ✅ Active |
| **📣 Community Outreach** | **Herald** | herald@nubimancy.com | Stakeholder | Monthly + Event-driven | 2025-08-18 | ✅ Active |
| **📝 Voice Synthesis** | **Scribe** | scribe@nubimancy.com | Stakeholder | Content-driven | 2025-08-18 | ✅ New |
| **📚 Education Development** | **Mentor** | mentor@nubimancy.com | Stakeholder | Monthly + Quarterly Reviews | 2025-08-17 | ✅ New |
| **✏️ Editorial Excellence** | **Echo** | echo@nubimancy.com | Stakeholder | Event-driven (content ready) | - | 🟡 Standby |
| **🔧 DevOps Mastery** | **Forge** | forge@nubimancy.com | Stakeholder | Event-driven (infrastructure) | - | 🟡 Standby |
| **🏰 Business Central Development** | **Maven** | maven@nubimancy.com | Stakeholder | Project-based learning | - | 🟡 Standby |
| **🤖 AI Development** | **Synth** | synth@nubimancy.com | Stakeholder | Project-based learning | 2025-08-18 | ✅ Active |
| **📚 Content Curation** | **Curator** | curator@nubimancy.com | Stakeholder | Content-driven + Monthly audits | 2025-08-18 | ✅ Active |
| **⚙️ M365 Copilot Extensibility** | **Nexus** | nexus@nubimancy.com | Stakeholder | Project-based learning | - | 🟡 Standby |
...
|-------------|-----------|------------------|-------------------|---------------|-----------------|
| `project-management.instructions.md` | **Atlas** | Azure DevOps, Project Leadership | Strategic planning, infrastructure coordination | `Project Management` | atlas@nubimancy.com |
| `content-planner.instructions.md` | **Quill** | Content Strategy, Technical Writing | Content creation, community engagement | `Content Planner` | quill@nubimancy.com |
| `community-outreach.instructions.md` | **Herald** | Social platforms, Networking | Community building, thought leadership | `Community Outreach` | herald@nubimancy.com |
| `scribe.instructions.md` | **Scribe** | Voice Synthesis, Authentic Content Creation | Voice pattern analysis, authentic writing | `Voice Synthesis` | scribe@nubimancy.com |
| `education-planning.instructions.md` | **Mentor** | Learning Design, Curriculum | Course development, skill mapping | `Education Planning` | mentor@nubimancy.com |
| `editor.instructions.md` | **Echo** | Technical Writing, Publishing | Editorial excellence, quality assurance | `Editor` | echo@nubimancy.com |
| `devops-engineer.instructions.md` | **Forge** | CI/CD, Infrastructure as Code | Automation, deployment pipelines | `DevOps Engineer` | forge@nubimancy.com |
| `business-central-developer.instructions.md` | **Maven** | Business Central, AL Development | ERP solutions, AppSource publishing | `Business Central Developer` | maven@nubimancy.com |
| `ai-developer.instructions.md` | **Synth** | Azure AI, Intelligent Applications | AI integration, prompt engineering | `AI Developer` | synth@nubimancy.com |
| `curator.instructions.md` | **Curator** | Content Management, Information Architecture | Content organization, ADO integration, archive maintenance | `Content Curation` | curator@nubimancy.com |
| `m365-copilot-extensibility.instructions.md` | **Nexus** | M365 Development, Copilot Extensibility | Plugin development, workspace enhancement | `M365 Copilot Extensibility` | nexus@nubimancy.com |
